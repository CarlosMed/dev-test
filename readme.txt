...
Develop this landing page mockup into a fully functional page with HTML and CSS. 
Absolutely no UI framework/library (ie. Bootstrap, Semantic, etc.) is to be used.
Bonus points for using a JS framework like Vue.js or React.js.
Extra Extra bonus points for connecting to an external JSON dataset for the content!

A jpeg and pdf are provided for reference. Optional PSD and Sketch files are linked below.
...
If you have a hosting platform like Github pages or Heroku, please use that in addition to emailing source. 
